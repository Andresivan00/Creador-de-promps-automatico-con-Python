...
#Datos base para la estructura de los prompts.
elementos_por_categoria = {
    "Fantasía": ["Mago", "Dragón", "Guerrero", "Castillo", "Hechizo"],
    "Futurista": ["Robot", "Ciudad neón", "Nave espacial", "Cyborg"],
    "Histórico": ["Samurái", "Caballero", "Reina", "Templo"],
    "Anime": ["Estudiante", "Héroe", "Demonio", "Idol"],
    "Naturaleza": ["Bosque", "Montaña", "Lago", "Cascada"],
    "Realista": ["Retrato", "Escena urbana", "Modelo", "Ciudad"],
    "Abstracto": ["Energía", "Luz", "Caos", "Emoción"]
}

estilos_visuales = [
    "Ilustración digital", "Óleo realista", "Cyberpunk",
    "Acuarela", "Concept art", "Manga"
]

iluminaciones = [
    "Dramática", "Neón", "Cálida", "Fría",
    "Atardecer", "Nocturna", "Luz natural"
]

composiciones = [
    "Primer plano", "Plano medio", "Plano general",
    "Perspectiva baja", "Vista aérea"
]

#Definición de funciones.

#Función para desplegar las opciones de elementos según la categoría escogida.
def actualizar_elementos(event=None):
    categoria = categoria_var.get()
    nuevos_elementos = elementos_por_categoria.get(categoria, [])
    elemento_var.set("")
...
def generar_prompt():
    ...
    if not (categoria and elemento and estilo and iluminacion and composicion):
...
crear_menu("Categoría:", categoria_var, elementos_por_categoria.keys(), actualizar_elementos)
